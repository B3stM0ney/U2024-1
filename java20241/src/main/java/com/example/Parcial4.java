    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < CarrerasMax; i++) {
            ...
            System.out.println("No. Carrera " + i +
                    ", Ganador: Código " + posicion[0] + " (" + nombresJockeys[posicion[0]] + "), Tiempo Ganador: "
                    + tiempos[0] +
                    ", Segundo: Código " + posicion[1] + " (" + nombresJockeys[posicion[1]] + "), Tiempo Segundo: "
                    + tiempos[1] +
                    ", Tercero: Código " + posicion[2] + " (" + nombresJockeys[posicion[2]] + "), Tiempo Tercero: "
                    + tiempos[2]);
        }
        ...
        for (int i = 0; i < 3; i++) {
            ...
            System.out.println(
                    (i + 1) + "º lugar: " + nombresJockeys[jockeyConMaxPuntos] + " con " + maxPuntos + " puntos");
